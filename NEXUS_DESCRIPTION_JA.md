...
バージョン1.0.1は、実深度を併用する人物保護と、地形・水面との境界を滑らかに保ちながら空をDoFから除外する機能を追加します。空をぼかさない場合は明るいボケの強調からも空を除外し、水平線の境目や明るい輪郭を抑えながら奥行き表現を維持します。Skyrim 1.6.1170／1.7.104対応と従来のプリセット互換性も維持します。
